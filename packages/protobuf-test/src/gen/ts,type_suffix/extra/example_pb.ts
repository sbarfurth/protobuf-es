...
// @generated by protoc-gen-es v2.2.3 with parameter "target=ts,import_extension=js,type_suffix=Bar"
 ...
 */
export type UserBar = Message<"example.User"> & {
  /**
 ...
 * Use `create(UserBarSchema)` to create a new message.
 */
export const UserBarSchema: GenMessage<UserBar> = /*@__PURE__*/
