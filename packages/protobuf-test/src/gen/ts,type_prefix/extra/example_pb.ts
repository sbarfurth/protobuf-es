...
// @generated by protoc-gen-es v2.2.3 with parameter "target=ts,import_extension=js,type_prefix=Foo"
 ...
 */
export type FooUser = Message<"example.User"> & {
  /**
 ...
 * Use `create(FooUserSchema)` to create a new message.
 */
export const FooUserSchema: GenMessage<FooUser> = /*@__PURE__*/
