...
// @generated by protoc-gen-es v2.2.3 with parameter "target=ts,import_extension=js,type_prefix=Foo,type_suffix=Bar"
 ...
 */
export type FooUserBar = Message<"example.User"> & {
  /**
 ...
 * Use `create(FooUserBarSchema)` to create a new message.
 */
export const FooUserBarSchema: GenMessage<FooUserBar> = /*@__PURE__*/
